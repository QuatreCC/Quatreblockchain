...
namespace CryptoNote {
    namespace parameters {
        const uint64_t DIFFICULTY_TARGET                             = 21;
        const uint64_t DIFFICULTY_TARGET_V2                          = 21;
        ...
        const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x258c;
        ...
        const uint64_t MONEY_SUPPLY                                  = UINT64_C(100'000'000'00000000);

        const uint32_t EMISSION_SPEED_FACTOR                         = 18;
        const uint32_t EMISSION_SPEED_FACTOR_V2                      = 19;
        ...
        const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(1'000'00000000);

        /* PREMINE
           ================================
           Development Coins:   1,000 QUATRE
           ================================ */

        const char GENESIS_COINBASE_TX_HEX[] = "010501ff000180d0dbc3f40202e49a4d2df65f350466a2fab12b388e237e967a3373e85737cd74b29dc675795d2101202e1e640096672f85bc036e073bd412a296fe67d4af72abf71a0885bbcf3385";
    ...
    const char     CRYPTONOTE_NAME[]                             = "Quatre";
    ...
    const int      SERVICE_DEFAULT_PORT                          =  20003;
    ...
    const char     LATEST_VERSION_URL[]                          = "https://github.com/Quatre-Project/Quatre/releases";
    const std::string LICENSE_URL                                = "https://github.com/Quatre-Project/Quatre/blob/master/LICENSE";
    const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
    {
        {  0xb1, 0xc3, 0xcc, 0x11, 0x45, 0x22, 0x5b, 0xbc, 0x10, 0x11, 0x23, 0x3d, 0x28, 0x5d, 0x54, 0x10  }
    };

    const char* const SEED_NODES[] = {
        "185.82.216.206:20001",
        "185.82.217.128:20001"
    };
}
